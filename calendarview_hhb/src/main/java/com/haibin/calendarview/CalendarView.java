...
public class CalendarView extends FrameLayout {
     ...
     * 设置选择范围
     */
    public void setSelectDateRange(java.util.Calendar first, java.util.Calendar last) {
        Calendar start = new Calendar();
        start.setYear(first.get(java.util.Calendar.YEAR));
        start.setMonth(first.get(java.util.Calendar.MONTH));
        start.setDay(first.get(java.util.Calendar.DAY_OF_MONTH));
        Calendar end = new Calendar();
        end.setYear(last.get(java.util.Calendar.YEAR));
        end.setMonth(last.get(java.util.Calendar.MONTH));
        end.setDay(last.get(java.util.Calendar.DAY_OF_MONTH));
        Log.e("TAG", "start = " + start);
        Log.e("TAG", "end = " + end);

        mDelegate.mSelectedStartRangeCalendar = start;
        mDelegate.mSelectedEndRangeCalendar = end;
        mWeekPager.updateRange();
        mMonthPager.updateRange();
        mSelectLayout.updateRange();
    }
